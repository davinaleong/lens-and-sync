...
- [ ] **5. Embedding generation** — call embedding model, batch requests, handle rate limits/retries
...
- [ ] **9. Scheduling** — cron/queue-based periodic sync with job locking to prevent overlapping runs
...
- [ ] **8. Recipe generation** — LLM call using identified dish, ingredient list + steps, home-kitchen feasibility constraints
- [ ] **9. Nutrition info** — nutrition API lookup (Edamam/USDA) or LLM estimation matched to generated ingredients
